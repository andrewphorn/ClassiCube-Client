                    ...
                    if (renderer.minecraft.level != null && player != null) {
                        ...
                        if (heldBlock.moving) {
                            ...
                            GL11.glTranslatef(
                                    ...
                                    MathHelper.sin(
                                            MathHelper.sqrt(var74) * 3.1415927F * 2F) * 0.2F,
                                    -var33 * 0.2F);
                        }
                        ...
                        if (heldBlock.moving) {
                            var33 = MathHelper
                                    .sin((var74 = (heldBlock.offset + var80) / 7F)
                                            * var74
                                            * 3.1415927F);
                            GL11.glRotatef(
                                    MathHelper.sin(
                                            MathHelper.sqrt(var74) * 3.1415927F) * 80F,
                                    0F, 1F, 0F);
        ...
        if (currentScreen instanceof BlockSelectScreen) {
            ...
            if (currentScreen == null) {
                if (Mouse.isButtonDown(MB_LEFT)
                        && ticks - lastClick >= timer.tps / 4F && hasMouse) {
                    onMouseClick(MB_LEFT);
                    lastClick = ticks;
                }
