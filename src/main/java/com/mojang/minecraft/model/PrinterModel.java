...
public class PrinterModel extends Model {
	...
	public PrinterModel() {
		...
		RightWall.allowTransparency = true;
		...
		LeftWall.allowTransparency = true;
		...
		MiddleComp.allowTransparency = true;
		...
		WholeBase.allowTransparency = true;
		...
		TopLeftNobble.allowTransparency = true;
		...
		TopRightNobble.allowTransparency = true;
		...
		TopMiddleNobble.allowTransparency = true;
		...
		LeftLine.allowTransparency = true;
		...
		RightLine.allowTransparency = true;
