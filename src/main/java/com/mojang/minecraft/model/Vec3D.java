...
public final class Vec3D {
	...
	public final Vec3D getXIntersection(Vec3D var1, float var2) {
		...
		return var3 * var3 < 1.0E-7F ? null : ((var2 = (var2 - this.x) / var3) >= 0.0F
				&& var2 <= 1.0F ? new Vec3D(this.x + var3 * var2, this.y + var4 * var2, this.z
				+ var5 * var2) : null);
	}
	...
	public final Vec3D getYIntersection(Vec3D var1, float var2) {
		...
		float var4 = var1.y - this.y;
		float var5 = var1.z - this.z;
		return var4 * var4 < 1.0E-7F ? null : ((var2 = (var2 - this.y) / var4) >= 0.0F
				&& var2 <= 1.0F ? new Vec3D(this.x + var3 * var2, this.y + var4 * var2, this.z
				+ var5 * var2) : null);
	}
	...
	public final Vec3D getZIntersection(Vec3D var1, float var2) {
		...
		return (var5 = var1.z - this.z) * var5 < 1.0E-7F ? null
				: ((var2 = (var2 - this.z) / var5) >= 0.0F && var2 <= 1.0F ? new Vec3D(this.x
						+ var3 * var2, this.y + var4 * var2, this.z + var5 * var2) : null);
	}
