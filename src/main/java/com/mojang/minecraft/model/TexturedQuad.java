...
public final class TexturedQuad {
    ...
    public TexturedQuad(Vertex[] var1, float var2, float var3, float var4,
	    float var5) {
	this(var1);
	...
	var1[0] = var1[0].create((float) var4 / 64.0F - var7, (float) var3
		/ 32.0F + var6);
	var1[1] = var1[1].create((float) var2 / 64.0F + var7, (float) var3
		/ 32.0F + var6);
	var1[2] = var1[2].create((float) var2 / 64.0F + var7, (float) var5
		/ 32.0F - var6);
	var1[3] = var1[3].create((float) var4 / 64.0F - var7, (float) var5
		/ 32.0F - var6);
    }
}
