...
public final class ModelManager {
	...
	return (Model) (var1.equals("humanoid") ? this.human : (var1
		...
		: (var1.equals("chicken") ? this.chicken : (var1
			.equals("skeleton") ? this.skeleton : (var1
			.equals("printer") ? this.printer
			: (var1.equals("croc") ? this.croc
				: (var1.equals("zombie") ? this.zombie : (var1
					.equals("pig") ? this.pig : (var1
					.equals("sheep") ? this.sheep : (var1
					.equals("spider") ? this.spider : (var1
					.equals("sheep.fur") ? this.sheepFur
					: null))))))))))));
    }
}
