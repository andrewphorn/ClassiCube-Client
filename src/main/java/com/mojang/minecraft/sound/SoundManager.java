...
public final class SoundManager {
	...
	if (var4 == null) {
	    ...
	    SoundData var7 = (SoundData) var4.get(this.random.nextInt(var4
		    .size()));
	...
	try {
	    for (var2 = var2.substring(0, var2.length() - 4).replaceAll("/",
		    "."); Character.isDigit(var2.charAt(var2.length() - 1)); var2 = var2
		    .substring(0, var2.length() - 1)) {
		;
	    }
