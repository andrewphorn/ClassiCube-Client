...
public class GuiScreen extends Screen {
	...
	for (int var3 = 0; var3 < this.buttons.size(); ++var3) {
		...
		GL11.glBindTexture(3553,
			var7.textureManager.load("/gui/gui.png"));
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
		byte var9 = 1;
		boolean var6 = var1 >= var4.x && var2 >= var4.y
			&& var1 < var4.x + var4.width
		...
		var4.drawImage(var4.x, var4.y, 0, 46 + var9 * 20,
			var4.width / 2, var4.height);
		var4.drawImage(var4.x + var4.width / 2, var4.y,
			200 - var4.width / 2, 46 + var9 * 20, var4.width / 2,
			var4.height);
		if (!var4.active) {
		    drawCenteredString(var8, var4.text,
			    var4.x + var4.width / 2, var4.y + (var4.height - 8)
				    / 2, -6250336);
		} else if (var6) {
		    drawCenteredString(var8, var4.text,
			    var4.x + var4.width / 2, var4.y + (var4.height - 8)
	...
	if (var3 == 0) {
		...
		Button var4;
		Button var7;
		if ((var7 = var4 = (Button) this.buttons.get(var3)).active
			&& var1 >= var7.x && var2 >= var7.y
	...
	if (Mouse.getEventButtonState()) {
	    ...
	    int var2 = this.height - Mouse.getEventY() * this.height
	...
	if (Keyboard.getEventKeyState()) {
	    this.onKeyPress(Keyboard.getEventCharacter(),
