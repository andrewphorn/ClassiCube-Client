...
public class GuiScreen extends Screen {
    ...
    public void render(int mouseX, int mouseY) {
        for (Button button : buttons) {
            ...
            button.drawImage(button.x, button.y, 0, 46 + spriteOffset * 20, button.width / 2,
                    button.height);
            button.drawImage(button.x + button.width / 2, button.y, 200 - button.width / 2,
                    46 + spriteOffset * 20, button.width / 2, button.height);
            ...
            drawCenteredString(minecraft.fontRenderer, button.text, button.x + button.width / 2,
                    button.y + (button.height - 8) / 2, textColorRGBA);
        }
    }
