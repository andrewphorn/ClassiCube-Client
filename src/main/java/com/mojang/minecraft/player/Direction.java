...
public class Direction {
	...
	if (paramInt == settings.forwardKey.key)
	    this.keylist[0] = paramBoolean;
	if (paramInt == settings.leftKey.key)
	    this.keylist[1] = paramBoolean;
	if (paramInt == settings.backKey.key)
	    this.keylist[2] = paramBoolean;
	if (paramInt == settings.rightKey.key)
	    this.keylist[3] = paramBoolean;
	if (paramInt == 57)
	    this.keylist[4] = paramBoolean;
	if (paramInt == 16)
	    this.keylist[5] = paramBoolean;
	if (paramInt == 18)
	    this.keylist[6] = paramBoolean;
	if (paramInt == 42)
	    this.keylist[7] = paramBoolean;
	if (paramInt == 29)
	    this.keylist[8] = paramBoolean;
	if (paramInt == 45)
	    this.keylist[9] = paramBoolean;
