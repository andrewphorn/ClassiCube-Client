...
public class Particle extends Entity {
    ...
    public Particle(Level var1, float var2, float var3, float var4, float var5,
	...
	var2 = MathHelper.sqrt(this.xd * this.xd + this.yd * this.yd + this.zd
		* this.zd);
	...
	var1.color(this.rCol * var21.R, this.gCol * var21.G, this.bCol
		* var21.B);
	var1.vertexUV(var13 - var3 * var12 - var6 * var12,
		var14 - var4 * var12, var15 - var5 * var12 - var7 * var12,
		var8, var11);
	var1.vertexUV(var13 - var3 * var12 + var6 * var12,
		var14 + var4 * var12, var15 - var5 * var12 + var7 * var12,
		var8, var10);
