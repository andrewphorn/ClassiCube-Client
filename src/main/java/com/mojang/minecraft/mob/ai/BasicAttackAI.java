...
public class BasicAttackAI extends BasicAI {
	...
	if (this.attackTarget != null) {
	    ...
	    float var6;
	    if ((var6 = var3 * var3 + var4 * var4 + var5 * var5) > var2 * var2
		    * 2.0F * 2.0F
		...
		this.mob.yRot = (float) (Math.atan2((double) var5,
			(double) var3) * 180.0D / 3.1415927410125732D) - 90.0F;
		this.mob.xRot = -((float) (Math.atan2((double) var4,
			(double) var6) * 180.0D / 3.1415927410125732D));
