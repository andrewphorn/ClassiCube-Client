...
final class Creeper$1 extends BasicAttackAI {
	...
	for (int var2 = 0; var2 < 500; ++var2) {
	    ...
	    float var6 = MathHelper.sqrt(var3 * var3 + var4 * var4 + var5
		    * var5);
	    float var7 = var3 / var6 / var6;
	    float var8 = var4 / var6 / var6;
	    var6 = var5 / var6 / var6;
	    this.level.particleEngine.spawnParticle(new TerrainParticle(
		    this.level, this.mob.x + var3, this.mob.y + var4,
		    this.mob.z + var5, var7, var8, var6, Block.LEAVES));
	}
