...
public abstract class Entity implements Serializable {
	...
	public void setPos(float var1, float var2, float var3) {
		...
		this.bb = new AABB(var1 - var4, var2 - var5, var3 - var4, var1 + var4,
				var2 + var5, var3 + var4);
	}
	...
	public void move(float var1, float var2, float var3) {
		if (this.noPhysics) {
			...
			if (this.footSize > 0.0F && var16 && this.ySlideOffset < 0.05F
				...
				for (var15 = 0; var15 < var10.size(); ++var15) {
					var2 = ((AABB) var10.get(var15))
							.clipYCollide(this.bb, var2);
				}
				...
				for (var15 = 0; var15 < var10.size(); ++var15) {
					var1 = ((AABB) var10.get(var15))
							.clipXCollide(this.bb, var1);
				}
				...
				for (var15 = 0; var15 < var10.size(); ++var15) {
					var3 = ((AABB) var10.get(var15))
							.clipZCollide(this.bb, var3);
				}
		...
		if (this.makeStepSound) {
			...
			if (this.walkDist > (float) nextStep && var19 > 0) {
				...
				if(TileSoundType == null)TileSoundType = Tile$SoundType.none;

				if (TileSoundType != Tile$SoundType.none) {
					this.playSound("step." + TileSoundType.name,
							TileSoundType.getVolume() * 0.75F, TileSoundType.getPitch());
				}
			}
		}
	...
	public boolean isUnderWater() {
		int var1;
		return (var1 = this.level.getTile((int) this.x, (int) (this.y + 0.12F),
				(int) this.z)) != 0 ? Block.blocks[var1].getLiquidType()
				.equals(LiquidType.WATER) : false;
	}
