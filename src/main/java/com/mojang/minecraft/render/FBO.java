...
public class FBO {
	...
	private void initarb() {
		...
		ARBFramebufferObject.glFramebufferTexture2D(36160, 36064, 3553, this.texture_index.get(0),
				0);
		...
		ARBFramebufferObject.glFramebufferTexture2D(36160, 36064, 3553, this.texture_index.get(1),
				0);
		...
		ARBFramebufferObject.glFramebufferTexture2D(36160, 36064, 3553, this.texture_index.get(2),
				0);
		...
		case 36053:
			break;
		case 36054:
			throw new RuntimeException("FrameBuffer: " + this.fbo_index
