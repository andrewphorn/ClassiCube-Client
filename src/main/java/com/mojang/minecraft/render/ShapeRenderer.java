...
public final class ShapeRenderer {
    ...
    public void addBox(float paramFloat1, float paramFloat2, float paramFloat3,
	    float paramFloat4, float paramFloat5, float paramFloat6,
	    float paramFloat7, float paramFloat8) {
	addPoint(paramFloat1, paramFloat2 + paramFloat4, 0.0F, paramFloat5,
		paramFloat6 + paramFloat8);
	addPoint(paramFloat1 + paramFloat3, paramFloat2 + paramFloat4, 0.0F,
		paramFloat5 + paramFloat7, paramFloat6 + paramFloat8);
	addPoint(paramFloat1 + paramFloat3, paramFloat2, 0.0F, paramFloat5
		+ paramFloat7, paramFloat6);
	...
	if ((this.numPoints % 4 == 0)
		&& (this.numFloats + (this.vertexLength << 2) >= 524288))
	    end();
    }
    ...
    public final void vertexUV(float var1, float var2, float var3, float var4,
	    float var5) {
	if (!this.texture) {
	    this.vertexLength += 2;
	}
	...
	if (this.vertices % 4 == 0
		&& this.length >= 524288 - (this.vertexLength << 2)) {
	    this.end();
	}
