...
public final class TextureLavaFX extends TextureFX {
	...
	for (var1 = 0; var1 < 16; ++var1) {
		...
		var3 = 0.0F;
		int var4 = (int) (MathHelper
			.sin((float) var2 * 3.1415927F * 2.0F / 16.0F) * 1.2F);
		var5 = (int) (MathHelper
			.sin((float) var1 * 3.1415927F * 2.0F / 16.0F) * 1.2F);
		...
		this.green[var1 + (var2 << 4)] = var3
			/ 10.0F
			+ (this.blue[(var1 & 15) + ((var2 & 15) << 4)]
				+ this.blue[(var1 + 1 & 15)
					+ ((var2 & 15) << 4)]
				+ this.blue[(var1 + 1 & 15)
					+ ((var2 + 1 & 15) << 4)] + this.blue[(var1 & 15)
