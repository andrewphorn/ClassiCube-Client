...
public final class LevelRenderer {
	...
	for (var7 = -var5 * var6; var7 < var9.level.width + var5 * var6; var7 += var5) {
	    for (int var8 = -var5 * var6; var8 < var9.level.height + var5
		    * var6; var8 += var5) {
		waterLevel = groundLevel;
		if (var7 >= 0 && var8 >= 0 && var7 < var9.level.width
		...
		var11.vertexUV((float) (var7 + var5), waterLevel,
			(float) (var8 + var5), (float) var5, (float) var5);
		var11.vertexUV((float) (var7 + var5), waterLevel, (float) var8,
			(float) var5, 0.0F);
		var11.vertexUV((float) var7, waterLevel, (float) var8, 0.0F,
			0.0F);
	    }
	}
	...
	for (var7 = 0; var7 < var9.level.width; var7 += var5) {
	    ...
	    var11.vertexUV((float) (var7 + var5), 0.0F, 0.0F, (float) var5,
		    0.0F);
	    var11.vertexUV((float) (var7 + var5), groundLevel, 0.0F,
		    (float) var5, groundLevel);
	    var11.vertexUV((float) var7, groundLevel, 0.0F, 0.0F, groundLevel);
	    var11.vertexUV((float) var7, groundLevel,
		    (float) var9.level.height, 0.0F, groundLevel);
	    var11.vertexUV((float) (var7 + var5), groundLevel,
		    (float) var9.level.height, (float) var5, groundLevel);
	    var11.vertexUV((float) (var7 + var5), 0.0F,
		    (float) var9.level.height, (float) var5, 0.0F);
	    var11.vertexUV((float) var7, 0.0F, (float) var9.level.height, 0.0F,
		    0.0F);
	}
	...
	for (var7 = 0; var7 < var9.level.height; var7 += var5) {
	    ...
	    var11.vertexUV(0.0F, groundLevel, (float) (var7 + var5),
		    (float) var5, 0.0F);
	    var11.vertexUV(0.0F, 0.0F, (float) (var7 + var5), (float) var5,
		    groundLevel);
	    var11.vertexUV(0.0F, 0.0F, (float) var7, 0.0F, groundLevel);
	    var11.vertexUV((float) var9.level.width, 0.0F, (float) var7, 0.0F,
		    groundLevel);
	    var11.vertexUV((float) var9.level.width, 0.0F,
		    (float) (var7 + var5), (float) var5, groundLevel);
	    var11.vertexUV((float) var9.level.width, groundLevel,
		    (float) (var7 + var5), (float) var5, 0.0F);
	    var11.vertexUV((float) var9.level.width, groundLevel, (float) var7,
		    0.0F, 0.0F);
	}
	...
	for (var6 = -var4 * var5; var6 < var9.level.width + var4 * var5; var6 += var4) {
		...
		if (var6 < 0 || var7 < 0 || var6 >= var9.level.width
			|| var7 >= var9.level.height) {
		    var11.vertexUV((float) var6, var13, (float) (var7 + var4),
			    0.0F, (float) var4);
		    var11.vertexUV((float) (var6 + var4), var13,
			    (float) (var7 + var4), (float) var4, (float) var4);
		    var11.vertexUV((float) (var6 + var4), var13, (float) var7,
			    (float) var4, 0.0F);
		    var11.vertexUV((float) var6, var13, (float) var7, 0.0F,
			    0.0F);
		    var11.vertexUV((float) var6, var13, (float) var7, 0.0F,
			    0.0F);
		    var11.vertexUV((float) (var6 + var4), var13, (float) var7,
	...
	GL11.glDisable(3042);
	GL11.glEndList();
	this.queueChunks(0, 0, 0, this.level.width, this.level.depth,
		this.level.height);
    }
	...
	for (int var7 = 0; var7 < this.loadQueue.length; ++var7) {
	    var6 = this.loadQueue[var7].appendLists(this.chunkDataCache, var6,
		    var2);
	}
