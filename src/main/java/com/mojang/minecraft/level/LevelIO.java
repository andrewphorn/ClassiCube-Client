...
public final class LevelIO {
		...
		try {
			...
			if ((var10 = new DataInputStream(new GZIPInputStream(var1))).readInt() != 656127880) {
				...
				if ((var12 = var10.readByte()) > 2) {
					...
					(var2 = (Level) (var13 = new LevelObjectInputStream(var10)).readObject())
							.initTransient();
					var13.close();
					return var2;
				}
	...
	public final Level loadOnline(String var1, String var2, int var3) {
		...
		try {
			...
			(var6 = (HttpURLConnection) (new URL("http://" + var1 + "/level/load.html?id=" + var3
					+ "&user=" + var2)).openConnection()).setDoInput(true);
			if (this.progressBar != null) {
	...
	public final boolean saveOnline(Level var1, String var2, String var3, String var4, String var5,
			int var6) {
		if (var4 == null) {
			var4 = "";
		}
		...
		try {
			...
			(var12 = (HttpURLConnection) (new URL("http://" + var2 + "/level/save.html"))
			...
			var13.write(var10);
			var13.close();
			BufferedReader var11 = new BufferedReader(new InputStreamReader(var12.getInputStream()));
