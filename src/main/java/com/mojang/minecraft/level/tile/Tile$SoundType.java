...
public enum Tile$SoundType {
	...
	none("none", 0, "-", 0.0F, 0.0F), grass("grass", 1, "grass", 0.6F, 1.0F), cloth("cloth", 2,
			"grass", 0.7F, 1.2F), gravel("gravel", 3, "gravel", 1.0F, 1.0F), stone("stone", 4,
			"stone", 1.0F, 1.0F), metal("metal", 5, "stone", 1.0F, 2.0F), wood("wood", 6, "wood",
			1.0F, 1.0F);
