...
public final class LevelGenerator {
	...
	CombinedNoise var6 = new CombinedNoise(new OctaveNoise(this.random, 8),
		new OctaveNoise(this.random, 8));
	CombinedNoise var7 = new CombinedNoise(new OctaveNoise(this.random, 8),
		new OctaveNoise(this.random, 8));
	...
	for (var11 = 0; var11 < var5.width; ++var11) {
		...
		double var13 = var6.compute((double) ((float) var11 * var10),
			(double) ((float) var12 * var10)) / 6.0D + (double) -4;
		double var15 = var7.compute((double) ((float) var11 * var10),
			(double) ((float) var12 * var10))
			/ 5.0D
			+ 10.0D
			+ (double) -4;
	...
	int[] var42 = var9;
	var5 = this;
	var7 = new CombinedNoise(new OctaveNoise(this.random, 8),
		new OctaveNoise(this.random, 8));
	CombinedNoise var49 = new CombinedNoise(
		new OctaveNoise(this.random, 8),
		new OctaveNoise(this.random, 8));
	...
	for (var51 = 0; var51 < var5.width; ++var51) {
		...
		double var21 = var7.compute((double) (var51 << 1),
			(double) (var54 << 1)) / 8.0D;
		var12 = var49.compute((double) (var51 << 1),
			(double) (var54 << 1)) > 0.0D ? 1 : 0;
		if (var21 > 2.0D) {
		    var23 = ((var42[var51 + var54 * var5.width] - var12) / 2 << 1)
			    + var12;
	...
	for (var24 = 0; var24 < var46; ++var24) {
		...
		var25 = (var23 = var42[var24 + var11 * var46] + var5.waterLevel)
			+ var12;
	...
	for (var11 = 0; var11 < var24; ++var11) {
		...
		var61 += var64 * 0.2F;
		var64 = (var64 *= 0.9F)
			+ (var5.random.nextFloat() - var5.random.nextFloat());
		var29 = (var29 + var30 * 0.5F) * 0.5F;
		var30 = (var30 *= 0.75F)
			+ (var5.random.nextFloat() - var5.random.nextFloat());
		if (var5.random.nextFloat() >= 0.25F) {
		    float var43 = var55
			    + (var5.random.nextFloat() * 4.0F - 2.0F) * 0.2F;
		    float var50 = var59
			    + (var5.random.nextFloat() * 4.0F - 2.0F) * 0.2F;
		    float var33 = var56
			    + (var5.random.nextFloat() * 4.0F - 2.0F) * 0.2F;
		    float var34 = ((float) var5.height - var50)
			    / (float) var5.height;
		    var34 = 1.2F + (var34 * 3.5F + 1.0F) * var31;
		    var34 = MathHelper.sin((float) var32 * 3.1415927F
			    / (float) var26)
			    * var34;
			...
			for (int var36 = (int) (var50 - var34); var36 <= (int) (var50 + var34); ++var36) {
				...
				if (var38 * var38 + var39 * var39 * 2.0F
					...
					&& var36 < var5.height - 1
					&& var37 < var5.depth - 1) {
				    int var66 = (var36 * var5.depth + var37)
					    * var5.width + var35;
	...
	for (var11 = 0; var11 < var46; ++var11) {
		...
		var27 = ((var26 = var42[var11 + var12 * var46]) * var5.depth + var12)
			* var5.width + var11;
		if (((var28 = var5.blocks[((var26 + 1) * var5.depth + var12)
			* var5.width + var11] & 255) == Block.WATER.id || var28 == Block.STATIONARY_WATER.id)
	...
	for (var51 = 0; var51 < var48; ++var51) {
		...
		for (var26 = 0; var26 < 5; ++var26) {
		    ...
		    if ((var54 < 2 || var5.random.nextInt(4) == 0)
			    && var23 >= 0 && var25 >= 0 && var23 < var5.width
			    && var25 < var5.depth) {
			var27 = var42[var23 + var25 * var46] + 1;
			if ((var5.blocks[(var27 * var5.depth + var25)
				* var5.width + var23] & 255) == 0) {
			    var63 = (var27 * var5.depth + var25) * var5.width
				    + var23;
			    if ((var5.blocks[((var27 - 1) * var5.depth + var25)
				    * var5.width + var23] & 255) == Block.GRASS.id) {
				if (var54 == 0) {
	...
	for (var54 = 0; var54 < var51; ++var54) {
		...
		for (var63 = 0; var63 < 5; ++var63) {
		    ...
		    if ((var24 < 2 || var5.random.nextInt(4) == 0)
			    ...
			    && (var5.blocks[(var27 * var5.depth + var28)
				    * var5.width + var26] & 255) == 0) {
			int var62 = (var27 * var5.depth + var28) * var5.width
				+ var26;
			if ((var5.blocks[((var27 - 1) * var5.depth + var28)
				* var5.width + var26] & 255) == Block.STONE.id) {
			    if (var24 == 0) {
	...
	for (var54 = 0; var54 < var51; ++var54) {
		...
		for (var26 = 0; var26 < 20; ++var26) {
		    var23 += var5.random.nextInt(6) - var5.random.nextInt(6);
		    var25 += var5.random.nextInt(6) - var5.random.nextInt(6);
		    if (var23 >= 0 && var25 >= 0 && var23 < var5.width
			    && var25 < var5.depth) {
	...
	for (int var8 = 0; var8 < var7; ++var8) {
	    ...
	    int var12 = (int) ((this.random.nextFloat() + this.random
		    .nextFloat()) * 75.0F * (float) var2 / 100.0F);
		...
		var16 = (var16 *= 0.9F)
			+ (this.random.nextFloat() - this.random.nextFloat());
		float var18 = MathHelper.sin((float) var17 * 3.1415927F
			/ (float) var12)
			* (float) var2 / 100.0F + 1.0F;
		...
		for (int var19 = (int) (var9 - var18); var19 <= (int) (var9 + var18); ++var19) {
			...
			for (int var21 = (int) (var11 - var18); var21 <= (int) (var11 + var18); ++var21) {
			    ...
			    if (var22 * var22 + var23 * var23 * 2.0F + var24
				    * var24 < var18 * var18
				    && var19 >= 1
				    && var20 >= 1
				    && var21 >= 1
				    ...
				    && var20 < this.height - 1
				    && var21 < this.depth - 1) {
				int var26 = (var20 * this.depth + var21)
					* this.width + var19;
