...
public class BlockMap implements Serializable {
	...
	this.tmp.clear();
	return this.getEntities(var1, var2, var3, var4, var5, var6, var7,
		this.tmp);
    }

    public List<Entity> getEntities(Entity var1, float var2, float var3,
	    float var4, float var5, float var6, float var7, List<Entity> var8) {
	BlockMap$Slot var9 = this.slot.init(var2, var3, var4);
	BlockMap$Slot var10 = this.slot2.init(var5, var6, var7);

	for (int var11 = BlockMap$Slot.getXSlot(var9) - 1; var11 <= BlockMap$Slot
		.getXSlot(var10) + 1; ++var11) {
		...
		for (int var13 = BlockMap$Slot.getZSlot(var9) - 1; var13 <= BlockMap$Slot
		    ...
		    if (var11 >= 0 && var12 >= 0 && var13 >= 0
			    && var11 < this.width && var12 < this.depth
			    && var13 < this.height) {
			List<?> var14 = this.entityGrid[(var13 * this.depth + var12)
				* this.width + var11];

			for (int var15 = 0; var15 < var14.size(); ++var15) {
			    Entity var16;
			    if ((var16 = (Entity) var14.get(var15)) != var1
				    && var16.intersects(var2, var3, var4, var5,
					    var6, var7)) {
				var8.add(var16);
			    }
			}
	...
	for (int var1 = 0; var1 < this.width; ++var1) {
		...
		for (int var3 = 0; var3 < this.height; ++var3) {
		    List<?> var4 = this.entityGrid[(var3 * this.depth + var2)
			    * this.width + var1];
    ...
    public void render(Vec3D var1, Frustrum var2, TextureManager var3,
	    float var4) {
	for (int var5 = 0; var5 < this.width; ++var5) {
		...
		for (int var11 = 0; var11 < this.height; ++var11) {
		    List<?> var12;
		    if ((var12 = this.entityGrid[(var11 * this.depth + var8)
			    * this.width + var5]).size() != 0) {
			float var13 = (float) ((var11 << 4) - 2);
			float var14 = (float) ((var11 + 1 << 4) + 2);
			if (var2.isBoxInFrustrum(var6, var9, var13, var7,
				var10, var14)) {
			    float var16 = var14;
			    float var17 = var10;
			    float var15 = var7;
				...
				if (var19.frustrum[var20][0] * var18
					+ var19.frustrum[var20][1] * var13
					+ var19.frustrum[var20][2] * var14
					+ var19.frustrum[var20][3] <= 0.0F) {
				    var10000 = false;
				    break;
				}

				if (var19.frustrum[var20][0] * var15
					+ var19.frustrum[var20][1] * var13
					+ var19.frustrum[var20][2] * var14
					+ var19.frustrum[var20][3] <= 0.0F) {
				    var10000 = false;
				...
				Entity var22;
				if ((var22 = (Entity) var12.get(var23))
					.shouldRender(var1)) {
				    if (!var21) {
					AABB var24 = var22.bb;
					if (!var2.isBoxInFrustrum(var24.x0,
						var24.y0, var24.z0, var24.x1,
						var24.y1, var24.z1)) {
					    continue;
					}
				    }
