...
public class Level implements Serializable {
	...
	if (!this.networkMode) {
	    NextTickListEntry var5 = new NextTickListEntry(var1, var2, var3,
		    var4);
	    if (var4 > 0) {
	...
	for (int var5 = var1; var5 < var1 + var3; ++var5) {
		...
		int var8;
		for (var8 = this.depth - 1; var8 > 0
			&& !this.isLightBlocker(var5, var8, var6); --var8) {
		    ;
		}
		...
		if (var7 != var8) {
			...
			((LevelRenderer) this.listeners.get(var8)).queueChunks(
				var5 - 1, var9 - 1, var6 - 1, var5 + 1,
				var7 + 1, var6 + 1);
		    }
		}
	    }
	...
	if (!Float.isNaN(var1.x) && !Float.isNaN(var1.y)
		&& !Float.isNaN(var1.z)) {
	    if (!Float.isNaN(var2.x) && !Float.isNaN(var2.y)
		    && !Float.isNaN(var2.z)) {
		...
		while (var9-- >= 0) {
		    ...
		    if (var22 > 0
			    && (var21.getLiquidType() == LiquidType.NOT_LIQUID)) {
			MovingObjectPosition var23;
			if (var21.isCube()) {
			    if ((var23 = var21.clip(var6, var7, var8, var1,
				    var2)) != null) {
				return var23;
			    }
			} else if ((var23 = var21.clip(var6, var7, var8, var1,
				var2)) != null) {
			    return var23;
			}
		    }
    ...
    public void explode(Entity var1, float var2, float var3, float var4,
	    float var5) {
	...
	for (int var12 = var6; var12 < var7; ++var12) {
		...
		for (int var14 = var10; var14 < var11; ++var14) {
		    ...
		    if (var12 >= 0
			    ...
			    && var13 < this.depth
			    && var14 < this.height
			    && var15 * var15 + var16 * var16 + var17 * var17 < var5
				    * var5
			    && (var19 = this.getTile(var12, var13, var14)) > 0
			    && Block.blocks[var19].canExplode()) {
			Block.blocks[var19].dropItems(this, var12, var13,
				var14, 0.3F);
	...
	List<?> var18 = this.blockMap.getEntities(var1, (float) var6,
		(float) var8, (float) var10, (float) var7, (float) var9,
		(float) var11);

	for (var13 = 0; var13 < var18.size(); ++var13) {
	    Entity var20;
	    if ((var15 = (var20 = (Entity) var18.get(var13)).distanceTo(var2,
		    var3, var4) / var5) <= 1.0F) {
		var16 = 1.0F - var15;
	...
	return this.isLit(var1, var2, var3) ? new ColorCache(d, e, f)
		: new ColorCache(a, b, c);
    }
	...
	for (int var9 = var5 - 6; var9 <= var5 + 6; ++var9) {
		...
		if (this.isInBounds(var9, var14, var10)
			&& !this.isSolidTile(var9, var14, var10)) {
		    float var11 = (float) var9 + 0.5F - var1;

		    float var12;
		    float var13;
		    for (var13 = (float) (Math.atan2(
			    (double) (var12 = (float) var10 + 0.5F - var3),
			    (double) var11)
		    ...
		    var11 = MathHelper.sqrt(var11 * var11 + 4.0F + var12
			    * var12);
		    var11 = 1.0F / var11;
		    if (var13 > 1.0F) {
			var11 = 0.0F;
	...
	for (; var3 < var4; ++var3) {
		...
		for (int var10 = var7; var10 < var8; ++var10) {
		    AABB var11;
		    if (var3 >= 0 && var9 >= 0 && var10 >= 0
			    && var3 < this.width && var9 < this.depth
			    && var10 < this.height) {
			Block var12;
			if ((var12 = Block.blocks[this.getTile(var3, var9,
				var10)]) != null
				&& (var11 = var12.getCollisionBox(var3, var9,
					var10)) != null
				&& var1.intersectsInner(var11)) {
			    var2.add(var11);
			}
		    } else if ((var3 < 0 || var9 < 0 || var10 < 0
			    || var3 >= this.width || var10 >= this.height)
			    && (var11 = Block.BEDROCK.getCollisionBox(var3,
				    var9, var10)) != null
			    && var1.intersectsInner(var11)) {
			var2.add(var11);
		    }
	...
	return var1 >= 0 && var2 >= 0 && var3 >= 0 && var1 < this.width
		&& var2 < this.depth && var3 < this.height ? this.blocks[(var2
		* this.height + var3)
		* this.width + var1] & 255 : 0;
    }
	...
	if (this.blocks == null) {
		...
		this.blockMap = new BlockMap(this.width, this.depth,
			this.height);
	    }
	...
	return var1 >= 0 && var2 >= 0 && var3 >= 0 && var1 < this.width
		&& var2 < this.depth && var3 < this.height;
    }

    public boolean isLightBlocker(int var1, int var2, int var3) {
	Block var4;
	return (var4 = Block.blocks[this.getTile(var1, var2, var3)]) == null ? false
		: var4.isOpaque();
    }

    public boolean isLit(int var1, int var2, int var3) {
	return var1 >= 0 && var2 >= 0 && var3 >= 0 && var1 < this.width
		&& var2 < this.depth && var3 < this.height ? var2 >= this.blockers[var1
		+ var3 * this.width]
		: true;
    }
	...
	int var4;
	return (var4 = this.getTile((int) var1, (int) var2, (int) var3)) > 0
	...
	return this.isSolid(var1 - var4, var2 - var4, var3 - var4) ? true
		: (this.isSolid(var1 - var4, var2 - var4, var3 + var4) ? true
			: (this.isSolid(var1 - var4, var2 + var4, var3 - var4) ? true
				: (this.isSolid(var1 - var4, var2 + var4, var3
					+ var4) ? true
					: (this.isSolid(var1 + var4, var2
						- var4, var3 - var4) ? true
						: (this.isSolid(var1 + var4,
							var2 - var4, var3
								+ var4) ? true
							: (this.isSolid(var1
								+ var4, var2
	...
	for (var6 = var2; var6 <= var2 + 1 + var4; ++var6) {
		...
		for (var9 = var3 - var7; var9 <= var3 + var7 && var5; ++var9) {
		    if (var8 >= 0 && var6 >= 0 && var9 >= 0
			    && var8 < this.width && var6 < this.depth
			    && var9 < this.height) {
			if ((this.blocks[(var6 * this.height + var9)
				* this.width + var8] & 255) != 0) {
			    var5 = false;
			}
		    } else {
			var5 = false;
	...
	if (!var5) {
	    return false;
	} else if ((this.blocks[((var2 - 1) * this.height + var3) * this.width
		+ var1] & 255) == Block.GRASS.id
    ...
    public boolean netSetTileNoNeighborChange(int var1, int var2, int var3,
	    int var4) {
	if (var1 >= 0 && var2 >= 0 && var3 >= 0 && var1 < this.width
		&& var2 < this.depth && var3 < this.height) {
	    if (var4 == this.blocks[(var2 * this.height + var3) * this.width
		    + var1]) {
		return false;
	    } else {
		if (var4 == 0
		...
		for (var4 = 0; var4 < this.listeners.size(); ++var4) {
		    ((LevelRenderer) this.listeners.get(var4)).queueChunks(
			    var1 - 1, var2 - 1, var3 - 1, var1 + 1, var2 + 1,
			    var3 + 1);
		}
	...
	if (this.rendererContext$5cd64a7f != null) {
		...
		var5.soundPlayer.play(var6, new EntitySoundPos(var2,
			var5.player));
	    }
	}
    ...
    public void playSound(String var1, float var2, float var3, float var4,
	    float var5, float var6) {
	if (this.rendererContext$5cd64a7f != null) {
	    Minecraft var7;
	    if ((var7 = this.rendererContext$5cd64a7f).soundPlayer == null
		    || !var7.settings.sound) {
		return;
	    }
		...
		var7.soundPlayer.play(var8, new LevelSoundPos(var2, var3, var4,
			var7.player));
	    }
	}
    ...
    public boolean setTileNoNeighborChange(int var1, int var2, int var3,
	    int var4) {
	return this.networkMode ? false : this.netSetTileNoNeighborChange(var1,
		var2, var3, var4);
    }
	...
	if (this.tickCount % 5 == 0) {
		...
		if ((var8 = (NextTickListEntry) this.tickList.remove(0)).ticks > 0) {
		    ...
		    if (this.isInBounds(var8.x, var8.y, var8.z)
			    && (var9 = this.blocks[(var8.y * this.height + var8.z)
				    * this.width + var8.x]) == var8.block
			    && var9 > 0) {
			Block.blocks[var9].update(this, var8.x, var8.y, var8.z,
				this.random);
		    }
		}
	    }
	...
	for (var7 = 0; var7 < var6; ++var7) {
	    ...
	    byte var11 = this.blocks[(var12 * this.height + var10) * this.width
		    + var13];
	    if (Block.physics[var11]) {
		Block.blocks[var11].update(this, var13, var12, var10,
			this.random);
	    }
	}
	...
	if (var1 >= 0 && var2 >= 0 && var3 >= 0 && var1 < this.width
		&& var2 < this.depth && var3 < this.height) {
	    Block var5;
	    if ((var5 = Block.blocks[this.blocks[(var2 * this.height + var3)
		    * this.width + var1]]) != null) {
