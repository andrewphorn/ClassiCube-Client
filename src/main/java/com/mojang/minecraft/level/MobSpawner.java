...
public final class MobSpawner {
	...
	for (int var5 = 0; var5 < var1; ++var5) {
	    ...
	    int var8 = (int) (Math.min(this.level.random.nextFloat(),
		    this.level.random.nextFloat()) * (float) this.level.depth);
	    ...
	    if (!this.level.isSolidTile(var7, var8, var9)
		    ...
		    && (!this.level.isLit(var7, var8, var9) || this.level.random
			    .nextInt(5) == 0)) {
		for (int var10 = 0; var10 < 3; ++var10) {
			...
			var11 += this.level.random.nextInt(6)
				- this.level.random.nextInt(6);
			var12 += this.level.random.nextInt(1)
				- this.level.random.nextInt(1);
			var13 += this.level.random.nextInt(6)
				- this.level.random.nextInt(6);
			if (var11 >= 0
				&& var13 >= 1
				&& var12 >= 0
				&& var12 < this.level.depth - 2
				&& var11 < this.level.width
				&& var13 < this.level.height
				&& this.level.isSolidTile(var11, var12 - 1,
					var13)
				...
				var19 = var16 - var2.y;
				var20 = var17 - var2.z;
				if (var18 * var18 + var19 * var19 + var20
					* var20 < 256.0F) {
				    continue;
				}
			    } else {
			    ...
			    Object var21 = null;
			    if (var6 == 0) {
				var21 = new Zombie(this.level, var15, var16,
					var17);
			    }

			    if (var6 == 1) {
				var21 = new Skeleton(this.level, var15, var16,
					var17);
			    }
			    ...
			    if (var6 == 3) {
				var21 = new Creeper(this.level, var15, var16,
					var17);
			    }

			    if (var6 == 4) {
				var21 = new Spider(this.level, var15, var16,
					var17);
			    }

			    if (var6 == 5) {
				var21 = new Sheep(this.level, var15, var16,
					var17);
			    }
